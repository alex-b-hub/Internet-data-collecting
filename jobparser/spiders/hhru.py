...
class HhruSpider(scrapy.Spider):
    ...
    start_urls = ['https://izhevsk.hh.ru/search/vacancy?text=python&area=1&salary=&currency_code=RUR&experience=doesNotMatter&order_by=relevance&search_period=0&items_on_page=20&no_magic=true&L_save_area=true',
    ...
    def vacancy_parse(self, response: HtmlResponse):
        ...
        url = response.url
        yield JobparserItem(name=name, salary=salary, company=company, url=url)
